 ...
 * @author Vinícius
 */
public class JIFPlataforma extends javax.swing.JInternalFrame {
    PlataformaModel obj;
    PlataformaData DAO;
    ArrayList<PlataformaModel> lista;
    int acao=0;
    /**
     * Creates new form JIFPlataforma
     */
    public JIFPlataforma() {
        initComponents();
        try {
        obj = new PlataformaModel();
        DAO = new PlataformaData();
        lista = new ArrayList<>();
        } catch (Exception e) {
        ...
        }
{
    ...
    private void initComponents() {
        ...
        jtPlataforma.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
    ...
    private void jtbDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbDadosMouseClicked
        try {
            ...
            if(linha>-1){
                ...
                jtPlataforma.setText(jtbDados.getValueAt(linha, 1).toString());
...
public boolean validarCampos(){
    if(jtPlataforma.getText().length()<3){
...
public boolean preencherObjeto(){
    ...
    obj.setDescricao(jtPlataforma.getText());
    return true;
}
}
